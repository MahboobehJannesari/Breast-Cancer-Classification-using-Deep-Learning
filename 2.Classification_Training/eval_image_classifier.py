...
def main(_):
  ...
  with tf.Graph().as_default():
    ...
    names_to_values, names_to_updates = slim.metrics.aggregate_metric_map({
        ...
        # 'xx':tf.Print(predictions.eval()),
        # 'confusion matrix':slim.metrics.confusion_matrix(predictions, labels),
        # 'false_negatives_at_thresholds': slim.metrics.streaming_false_negatives_at_thresholds(predictions, labels,200),

        # 'Specificity_at_sensitivity': slim.metrics.streaming_specificity_at_sensitivity(predictions, labels),
